...
module Api.Object.Purchase_aggregate_fields exposing (..)
...
type alias CountOptionalArguments =
    { columns : OptionalArgument (List Api.Enum.Purchase_select_column.Purchase_select_column)
...
count fillInOptionals =
    let
        ...
        optionalArgs =
            [ Argument.optional "columns" filledInOptionals.columns (Encode.enum Api.Enum.Purchase_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals.distinct Encode.bool ]
