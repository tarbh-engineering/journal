...
count :
    ...
    -> SelectionSet (Maybe Int) Api.Object.Post_aggregate_fields
...
max :
    SelectionSet decodesTo Api.Object.Post_max_fields
    -> SelectionSet (Maybe decodesTo) Api.Object.Post_aggregate_fields
max object_ =
    Object.selectionForCompositeField "max" [] object_ (identity >> Decode.nullable)


min :
    SelectionSet decodesTo Api.Object.Post_min_fields
    -> SelectionSet (Maybe decodesTo) Api.Object.Post_aggregate_fields
min object_ =
