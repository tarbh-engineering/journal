...
body : SelectionSet String Api.Object.Post
body =
...
-}
postTagsBypostId : (PostTagsBypostIdOptionalArguments -> PostTagsBypostIdOptionalArguments) -> SelectionSet decodesTo Api.Object.Post_tag -> SelectionSet (List decodesTo) Api.Object.Post
postTagsBypostId fillInOptionals object_ =
    let
        filledInOptionals =
    ...
    in
    Object.selectionForCompositeField "postTagsBypostId" optionalArgs object_ (identity >> Decode.list)


type alias PostTagsBypostIdAggregateOptionalArguments =
    { distinct_on : OptionalArgument (List Api.Enum.Post_tag_select_column.Post_tag_select_column)
    , limit : OptionalArgument Int
    , offset : OptionalArgument Int
    , order_by : OptionalArgument (List Api.InputObject.Post_tag_order_by)
...
-}
postTagsBypostId_aggregate : (PostTagsBypostIdAggregateOptionalArguments -> PostTagsBypostIdAggregateOptionalArguments) -> SelectionSet decodesTo Api.Object.Post_tag_aggregate -> SelectionSet decodesTo Api.Object.Post
postTagsBypostId_aggregate fillInOptionals object_ =
    let
        filledInOptionals =
            fillInOptionals { distinct_on = Absent, limit = Absent, offset = Absent, order_by = Absent, where_ = Absent }
        ...
        optionalArgs =
            [ Argument.optional "distinct_on" filledInOptionals.distinct_on (Encode.enum Api.Enum.Post_tag_select_column.toString |> Encode.list), Argument.optional "limit" filledInOptionals.limit Encode.int, Argument.optional "offset" filledInOptionals.offset Encode.int, Argument.optional "order_by" filledInOptionals.order_by (Api.InputObject.encodePost_tag_order_by |> Encode.list), Argument.optional "where" filledInOptionals.where_ Api.InputObject.encodePost_tag_bool_exp ]
                |> List.filterMap identity
    in
    Object.selectionForCompositeField "postTagsBypostId_aggregate" optionalArgs object_ identity


{-| An object relationship
-}
userByuserId : SelectionSet decodesTo Api.Object.User -> SelectionSet decodesTo Api.Object.Post
userByuserId object_ =
    Object.selectionForCompositeField "userByuserId" [] object_ identity


user_id : SelectionSet CustomScalars.Uuid Api.Object.Post
user_id =
