...
module Api.Object.User_aggregate_fields exposing (..)
...
count :
    ...
    -> SelectionSet (Maybe Int) Api.Object.User_aggregate_fields
...
max :
    SelectionSet decodesTo Api.Object.User_max_fields
    -> SelectionSet (Maybe decodesTo) Api.Object.User_aggregate_fields
max object_ =
    Object.selectionForCompositeField "max" [] object_ (identity >> Decode.nullable)


min :
    SelectionSet decodesTo Api.Object.User_min_fields
    -> SelectionSet (Maybe decodesTo) Api.Object.User_aggregate_fields
min object_ =
