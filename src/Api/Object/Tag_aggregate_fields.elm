...
count : (CountOptionalArguments -> CountOptionalArguments) -> SelectionSet (Maybe Int) Api.Object.Tag_aggregate_fields
...
max : SelectionSet decodesTo Api.Object.Tag_max_fields -> SelectionSet (Maybe decodesTo) Api.Object.Tag_aggregate_fields
max object_ =
    Object.selectionForCompositeField "max" [] object_ (identity >> Decode.nullable)


min : SelectionSet decodesTo Api.Object.Tag_min_fields -> SelectionSet (Maybe decodesTo) Api.Object.Tag_aggregate_fields
min object_ =
